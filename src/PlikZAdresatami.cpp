...
void PlikZAdresatami::zamaniaDanychWPliku(Adresat adresat)
{
    ...
    usunPlik(NAZWA_Z_PLIKU_Z_ADRESATAMI);
    zmienNazwePliku(nazwaTymczasowegoPlikuZAdresatami, NAZWA_Z_PLIKU_Z_ADRESATAMI);
}
...
void PlikZAdresatami::usunAdresata(vector <Adresat> &adresaci){
    ...
    for (vector <Adresat>::iterator itr = adresaci.begin(); itr != adresaci.end(); itr++)
    {
        if (itr -> pobierzID() == idUsuwanegoAdresata)
        {
            ...
            if (znak == 't')
            {
                numerLiniiUsuwanegoAdresata = zwrocNumerLiniiSzukanegoAdresata(*itr);
...
void PlikZAdresatami::usunWybranaLinieWPliku(int numerUsuwanejLinii)
{
    ...
    string nazwaTymczasowegoPlikuZAdresatami= "Adresaci_tymczasowo.txt";
    odczytywanyPlikTekstowy.open(NAZWA_Z_PLIKU_Z_ADRESATAMI.c_str(), ios::in);
    tymczasowyPlikTekstowy.open(nazwaTymczasowegoPlikuZAdresatami.c_str(), ios::out | ios::app);
